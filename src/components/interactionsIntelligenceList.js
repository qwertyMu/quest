...
export default function InteractionsIntelligenceList() {
  ...
  const columns = [
    ...
    { field: 'partner', headerName: 'Communication with', width: 180, type: 'string', editable: false },
    ...
    { field: 'exhibit', headerName: 'From exhibit', width: 180, type: 'string', editable: false },
    { field: 'file_name', headerName: 'Original file', width: 180, type: 'string', editable: false },
